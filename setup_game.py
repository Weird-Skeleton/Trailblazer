...
def new_game() -> Engine:
    ...
    """
    # TODO: Fix Damage Type Bug, Properly Implement starting gear
    Bug Desc : Player weapon attacks will display an error when trying to read the damage type from the weapon given at start - suspect it has
